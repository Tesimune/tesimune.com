...
export default function Navbar() {
  ...
  return (
    ...
    <div onClick={() => setOpen(!open)}
        className={`bg-transparent absolute grid justify-end w-full p-3 rounded-md md:hidden ${open ? '' : 'hidden'}`} id='menu'>
        <nav className='md:hidden grid gap-7'>
          ...
          <a href='#'><span className='pl-3 font-bold text-xs'>CV</span></a>
